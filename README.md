...
1. Download the zipped file containing this repository from the GitHub [page] (https://github.com/baxterlabZbrowse/Sitalica_v2.1).

2. Unzip the file.

3. Move `Sitalica_v2.1.csv` to the `annotations` folder in your Zbrowse directory.

4. Move `Sitalica_v2.1.txt` to the `organisms` folder in your Zbrowse directory.

5. If Zbrowse was running during this process, restart it so that the changes can take effect.

### Using the Data

Setaria italica will now be added to your instance of ZBrowse. Most notably, it will appear 
